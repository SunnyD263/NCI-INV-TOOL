...
echo            "<a href='#'>Info</a>";
echo            "<ul>";
echo                "<li><a href='infoarticle.php?FirstOpen='>InfoArtikl</a></li>";
echo            "</ul>";
echo        "</li>";
echo        "<li>";
echo            "<a href='#'>Inventura</a>";
echo            "<ul>";
echo                "<li><a href='invpal.php?FirstOpen='>Inventura palet</a></li>";
echo                "<li><a href='invpckbin.php?FirstOpen='>Inventura pickbin</a></li>";
echo            "</ul>";
echo        "</li>";
// echo        "<li>";
...
else
{
    ...
    echo            "<a href='#'>Administrace inventury</a>";
    echo            "<ul>";              
    echo                "<li><a href='invview.php?LoadForm='>Přehled inventury lokace</a></li>";
    echo                "<li><a href='invviewID.php?LoadForm='>Přehled inventury ID</a></li>";        
    echo                "<li><a href='admin.php?Delinv='>Smazat inventuru lokace</a></li>";
    echo            "</ul>";
    echo        "</li>";
    echo        "<li>";
